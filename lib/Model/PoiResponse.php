...
class PoiResponse implements ArrayAccess
{
    ...
    static $SystranTypes = array(
        ...
        'total' => 'int',
        'offset' => 'int',
        'points_of_interest' => 'Systran\Client\LitePOI[]'
    );
     ...
     * @param Systran\Client\LitePOI[] $points_of_interest Array of lite POI
     * @return $this
     */
