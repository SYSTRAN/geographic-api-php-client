...
use \ArrayAccess;
/**
 * PoiTypesResponse Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Systran\Client
 ...
 */
class PoiTypesResponse implements ArrayAccess
{
    /**
    ...
    /**
     * Sets poi_types
     * @param string[] $poi_types POI types
     * @return $this
     */
    public function setPoiTypes($poi_types)
    {
